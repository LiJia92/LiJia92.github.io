---
title: TextView 自定义“ellipsize”
date: 2019-12-24 11:23:43
tags:
 - 日常开发
---
...
使用：
```
TextViewSuffixWrapper(topicView.descTv).apply {
    targetLineCount = 3
    suffix = "...查看全部"
    suffix?.apply {
...
参考：[Android TextView用"查看更多"替代自带ellipsize](https://juejin.im/post/5d4a5fb66fb9a06b0517d7eb)